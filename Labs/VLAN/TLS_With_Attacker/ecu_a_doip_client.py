...
# TLS handshake BEFORE any DoIP communication
# FIXED: Compatible ciphers for TLS 1.1
# ============================================================
...
def discover():
    ...
    This is the ONLY unencrypted communication
    """
    ...
    udp.sendto(doip(0x0001, b""), (BROADCAST, DOIP_UDP_PORT))
...
{Y}🔐 All traffic encrypted via TLS{R}
""")
...
# ===================== MAIN =====================
print("="*70)
print(f"{M}🔒 DoIP UDS Tester with TLS 1.2 Encryption{R}")
...
print(f"{M}   4. UDS Diagnostics → All commands encrypted{R}")
